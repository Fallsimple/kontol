import os, sys
    os.system('reset')
print '\x1b[97mMangga Masukan token atau cokiee
print '\x1b[97mgk tau ya?? 
print '\x1b[97mMangga Login '
import os, sys

def id():
    os.system('simple sempurna')
athour:bang jor
github:github.com/Fallsimple

def selamat datang bangsat''
    ngulang = sys.executable
    os.execl(ngulang, ngulang, *sys.argv)


user = login token(': token')
user=login cokiee(': cookie')
